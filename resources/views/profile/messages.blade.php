...
@section('profile-content')
    ...
    <h1 class="my-3 text-white">Private Messages</h1>
    <hr>
    <div class="row justify-content-center">
        <div class="col-md-4">

            <a href="{{ route("profile.messages") }}">
                <h3 class="mb-3 text-white">Conversations</h3>
            </a>
            <hr>
        ...
        <div class="col-md-8">
            ...
            @else
                <h3 class="mb-3 text-white">Conversation with <em>{{ $conversation -> otherUser() -> username }}</em></h3>
                {{-- User is not a Stub --}}
