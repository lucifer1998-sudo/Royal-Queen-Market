...
@section('profile-content')
    ...
    <div class="row">
        <div class="col-md-12">
            <h1 class="mb-3 text-white">PGP keys</h1>
        </div>
        <div class="col-md-6">
            <h3 class="mb-3 text-white">Your pgp key</h3>
            <hr>

            @if(auth() -> user() -> hasPGP())
                <p class="text-white">Your PGP key is:</p>
            ...
            @endif
            <p class="text-white"><a href="{{ route('profile.pgp.old') }}">Old PGP keys</a></p>

        </div>
        <div class="col-md-6">
            <h3 class="mb-3 text-white">Set new PGP key</h3>
            <hr>
