...
@section('profile-content')
    ...
    <h1 class="my-3 text-white">Settings</h1>

    <h3 class="mt-4 text-white">Change password</h3>
    <hr>
    <form action="{{ route('profile.password.change') }}" method="POST" class="justify-content-between">
        {{ csrf_field() }}
        <div class="form-row my-2">
            <label for="old_password" class="col-form-label col-md-2 text-white">Old password:</label>
            <div class="col-md-10">
                <input type="password" class="form-control" id="old_password" name="old_password" placeholder="Type the old password">
            </div>
        </div>
        <div class="form-row my-2">
            <label for="new_password" class="col-form-label col-md-2 text-white">New password:</label>
            <div class="col-md-5">
    ...
    @endif
    <h3 class="mt-4 text-white">Two Factor Authentication</h3>
    <hr>
    <div class="row">
        <div class="col-md-6">
            <label class="text-white">2-Factor Authentication:</label>
        </div>
    ...
    <h3 class="mt-4 text-white">Referral link</h3>
    <hr>
    <div class="row">
        <div class="col-md-12">
    ...
    <h3 class="mt-4 text-white">Payment Addresses</h3>
    <hr>
