<div class="row">
    <div class="col-10">
        <h4 class="text-white">Items for sale <a href="{{route('search',['user'=>$vendor->username])}}" class="ml-2" style="font-size: 0.9em; text-decoration: none;">({{$vendor->products()->count()}})</a></h4>
    </div>
