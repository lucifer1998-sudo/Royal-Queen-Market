    ...
    <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
        ...
        @foreach($products as $product)
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    <img class="hover:grow hover:shadow-lg w-full" src="{{ asset('storage/'  . $product -> frontImage() -> image) }}" alt="{{$product->name}}">
                    ...
                    <p class="pt-1 text-gray-900">@include('includes.currency', ['usdValue' => $product -> price_from ])</p>
                </a>
            </div>
        @endforeach
