            ...
            <div class="flex justify-center px-96">
                <div class="bg-rqm-lighter shadow w-2/3">
                    ...
                    <div class="justify-center py-5 text-rqm-yellow">
                        ...
                        <div class="flex font-extralight justify-center text-1xl font-sans roboto w-full">Get Your Account in Minutes</div>
                    </div>
                    <form action="{{route('auth.signup.post')}}" method="POST">
                        ...
                        <div class="flex justify-center py-1">
                            <div class="flex justify-center">
                                <div class="bg-rqm-light px-2 py-1 relative flex w-full flex-wrap items-stretch">
                                    ...
                                    <input type="text" id="username" name="username" placeholder="Username" class=" py-1 rounded-full relative w-full pl-10 placeholder-rqm-dark" />
                                </div>
                            </div>
                        </div>
                        <div class="flex justify-center py-1">
                            <div class="flex justify-center">
                                <div class="bg-rqm-light px-2 py-1">
                                    ...
                                    <input type="password" id="password" name="password" placeholder="Password" class=" py-1 rounded-full relative w-full pl-10 placeholder-rqm-dark" />
                                </div>
                            </div>
                        </div>
                        <div class="flex justify-center py-1">
                        ...
                        <div class="flex justify-center py-1">
                            <div class="flex justify-center">
                                <div class="bg-rqm-light px-2 py-1">
                                    <span class="leading-snug z-10 absolute text-rqm-yellow items-center justify-center px-4 py-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" />
                                    </svg>
                                    </span>
                                    <input type="text" id="refid" name="refid" placeholder="Referral Code" class=" py-1 rounded-full relative w-full pl-10 placeholder-rqm-dark" />
                                </div>
                            </div>
                        </div>
                        <div class="flex justify-center pt-5">
                            <div>
                                ...
                                <div class="bg-rqm-light px-2 py-3 py-1">
                                    ...
                                    <input type="text" id="captcha" name="captcha" placeholder="Captcha" class=" py-1 rounded-full relative w-full pl-10 placeholder-rqm-dark" />
                                </div>
                            </div>
                        </div>
                        <div class="flex justify-center pt-5">
