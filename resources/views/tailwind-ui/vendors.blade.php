...
<div class="w-full flex">
    ...
    <div class="gap-7 grid grid-colss-3 pt-20 px-40">
        @foreach ($vendors as $vendor)

            <div class="border border-gray-500 flex flex-col py-5 rounded-2xl shadow-md relative mh-50">
                ...
                <div class="text-center pt-8 text-rqm-white text-xs">Last Seen: {{ $vendor->last_seen ?? 'n/a' }}</div>
{{--                <div class="absolute bottom-0 mr-2 right-0 text-rqm-white text-xs">Last Seen: {{ $vendor->last_seen ?? 'n/a' }}</div>--}}
                <div class="flex ml-2 mt-2 justify-center bottom-16 absolute left-7">
                ...
                <div class="flex  absolute bottom-4  justify-center">
                    <a href="{{route('search',['user'=>$vendor->username])}}">
                        <button class="bg-rqm-yellow-dark flex font-extrabold px-2 py-1 rounded-3xl text-rqm-dark">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                            </svg>
                        </span>
                            <span class="px-2">View All Products</span>
                        </button>
                    </a>
                </div>
            </div>
