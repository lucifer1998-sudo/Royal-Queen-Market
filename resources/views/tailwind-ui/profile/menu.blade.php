<div class="bg-rqm-dark py-10 rounded w-1/6 relative min-h-screen">
    ...
    <div class="py-2 pl-3 flex text-rqm-yellow-dark hover:bg-pink-800 hover:shadow @isnotroute('profile.notifications') hover:grow @endisnotroute @isroute('profile.notifications') transform scale-105 bg-pink-800 shadow @endisroute">
