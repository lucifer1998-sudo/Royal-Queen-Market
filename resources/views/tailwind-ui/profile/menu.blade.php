<div class="bg-rqm-dark py-10 rounded-3xl w-1/6">
    ...
    <div class="py-2 pl-3 flex text-rqm-yellow-dark hover:bg-pink-800 hover:shadow @isnotroute('profile.pgp') hover:grow @endisnotroute @isroute('profile.pgp')transform scale-105 bg-pink-800 shadow @endisroute">
