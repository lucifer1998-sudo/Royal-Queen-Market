    ...
    <div class="flex justify-center py-9 w-full">
        <div class="w-full">
            ...
            <form class="w-full" method="POST" action="{{ route('profile.pgp.post') }}">
                ...
                <small class="text-rqm-white">Paste your key here and later you'll need to confirm.</small>
