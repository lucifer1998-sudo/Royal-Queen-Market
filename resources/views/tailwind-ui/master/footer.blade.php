{{--<footer class="flex  py-10">--}}
    <footer class="flex justify-center text-center py-10 px-10 ">
            ...
            <div class=" justify-center pt-2 flex-grow" >
                    <ul>
                        <h2 class="text-rqm-yellow-darkest">Categories</h2>
            ...
            <div class="justify-center pt-2 flex-grow">
                    <ul>
                        <h2 class="text-rqm-yellow-darkest">Help</h2>
            ...
            <div class="justify-center pt-2 flex-grow">
                    <ul>
                        ...
                        <li class="bg-gray text-white mb-2">AUD
                            <span>123</span>
                        </li>
                        <li class="bg-gray text-white mb-2">CMF
                            <span>123</span>
                        </li>
                        <li class="bg-gray text-white mb-2">CAD
                            <span>123</span>
                        </li>
                    </ul>
                </div>
