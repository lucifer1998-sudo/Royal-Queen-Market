            ...
            <div class="flex justify-center px-96">
                <div class="bg-rqm-lighter shadow w-2/3">
                    ...
                    <div class="justify-center py-5 text-rqm-yellow">
                        <div class="text-2xl w-full flex justify-center font-sans roboto">Reset Password</div>
{{--                        <div class="flex font-extralight justify-center text-1xl w-full font-sans roboto">Sessions--}}
{{--                            expires every 90 minutes--}}
{{--                        </div>--}}
                    </div>
                    <form action="{{ route('a.mnemonic') }}" method="POST">
                        @csrf
                            ...
                            <div class="flex justify-center">
                                <div class="bg-rqm-light px-2 py-1 relative flex w-full flex-wrap items-stretch">
                                    ...
                                    <input type="text" id="username" name="username" placeholder="Username"
                                           class=" py-1 rounded-full relative w-full pl-10"/>
                                </div>
                            </div>
                        </div>
                        <div class="flex justify-center py-1">
                            <div class="flex justify-center">
                                <div class="bg-rqm-light px-2 py-1">
                                    ...
                                    <input type="text" id="password" name="mnemonic" placeholder="Mnemonic key"
                                           class=" py-1 rounded-full relative w-full pl-10"/>
                                </div>
                            </div>
                        </div>
                        <div class="flex justify-center pt-5 my-4">
                            <div>
                                <div class="flex justify-center text-lg text-rqm-yellow w-64">
                                    <button type="submit" value="Log In"
                                            class=" rounded bg-rqm-yellow font-black py-2 text-rqm-dark w-full">Reset Password
                                    </button>
                                </div>
                            </div>
                        </div>
