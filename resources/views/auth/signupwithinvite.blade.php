                            ...
                            <div class="flex justify-center">
                                <div class="bg-rqm-light px-2 py-1">
                                    <textarea rows="7" type="text" id="refid" name="notes"
                                              placeholder="Referral Code"
                                              class=" py-1 rounded relative w-full pl-10 placeholder-rqm-dark" readonly>
{{$notes}}
                                    </textarea>
                                </div>
                            </div>
                        ...
                        <div class="flex justify-center">
                            <div class="flex pb-4 w-64 text-center">
                                <span class="opacity-70 text-sm text-rqm-yellow">
                                     Secret Code
                                </span>
                            </div>
                        </div>
