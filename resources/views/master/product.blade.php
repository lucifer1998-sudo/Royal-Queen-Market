...
@section('content')
    ...
    <nav class="main-breadcrumb" aria-label="breadcrumb" >
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{ route('home') }}" style="color: black;">Products</a>
            </li>
            @foreach($product -> category -> parents() as $ancestor)
                <li class="breadcrumb-item" aria-current="page"><a
                            href="{{ route('category.show', $ancestor) }}" style="color: black;">{{ $ancestor -> name }}</a></li>
            @endforeach
            <li class="breadcrumb-item active" aria-current="page"><a
                        href="{{ route('category.show', $product -> category) }}" style="color: black;">{{ $product -> category -> name }}</a>
            </li>
        </ol>
    </nav>
        ...
        <div class="col-md-5">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <table class="table border-0 text-left table-borderless text-white">
                        <tbody>
    ...
    {{-- Product menu --}}
    <ul id="productsmenu" class="my-4 nav nav-tabs nav-fill text-white">
        <li class="nav-item">
